...
#define MAX_TEST_VALS 20*TEST_RANGE
...
static int gen_vals(int test_vals[], int min, int max, int test_range, int arg)
{
	...
	unsigned sig1 = 0x700000;
        unsigned sig2 = 0x7fffff;
        unsigned sig3 = 0x023456;
	...
	for (i = 0; i < test_range; i++) {
	    ...
	    test_vals[test_count++] = sign | (largest_norm - i);
            //added by gy 2023.12 for norm overflow (float_twice) 
            test_vals[test_count++] = (largest_norm - i) | sig1; 
	    test_vals[test_count++] = sign | (largest_norm - i)|sig1; 
            test_vals[test_count++] = (largest_norm - i) | sig2; 
	    test_vals[test_count++] = sign | (largest_norm - i)|sig2;
            test_vals[test_count++] = (largest_norm - i) | sig3; 
	    test_vals[test_count++] = sign | (largest_norm - i)|sig3;  
