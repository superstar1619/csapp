...
08049230 <deregister_tm_clones>:
 8049230:	b8 7c c0 04 08       	mov    $0x804c07c,%eax
 8049235:	3d 7c c0 04 08       	cmp    $0x804c07c,%eax
 ...
 804924b:	68 7c c0 04 08       	push   $0x804c07c
...
08049270 <register_tm_clones>:
 8049270:	b8 7c c0 04 08       	mov    $0x804c07c,%eax
 8049275:	2d 7c c0 04 08       	sub    $0x804c07c,%eax
 ...
 8049297:	50                   	push   %eax
 8049298:	68 7c c0 04 08       	push   $0x804c07c
...
080492b0 <__do_global_dtors_aux>:
 ...
 80492b4:	80 3d a4 c0 04 08 00 	cmpb   $0x0,0x804c0a4
 ...
 80492c8:	c6 05 a4 c0 04 08 01 	movb   $0x1,0x804c0a4
 80492cf:	c9                   	leave  
 80492d0:	c3                   	ret    
...
0804932b <sendfile>:
 ...
 8049416:	a1 b4 c0 04 08       	mov    0x804c0b4,%eax
...
080494ff <client>:
 ...
 8049580:	a3 b4 c0 04 08       	mov    %eax,0x804c0b4
 ...
 804966a:	a1 b0 c0 04 08       	mov    0x804c0b0,%eax
 ...
 8049737:	68 b9 c0 04 08       	push   $0x804c0b9
 804973c:	ff b5 6c ff ff ff    	push   -0x94(%ebp)
 8049742:	e8 59 fa ff ff       	call   80491a0 <recv@plt>
 8049747:	83 c4 10             	add    $0x10,%esp
 804974a:	0f b6 05 b9 c0 04 08 	movzbl 0x804c0b9,%eax
 8049751:	83 e8 30             	sub    $0x30,%eax
 8049754:	a2 b9 c0 04 08       	mov    %al,0x804c0b9
 8049759:	0f b6 05 b9 c0 04 08 	movzbl 0x804c0b9,%eax
 ...
 80499e6:	0f b6 05 b8 c0 04 08 	movzbl 0x804c0b8,%eax
 ...
 8049a06:	0f b6 05 b8 c0 04 08 	movzbl 0x804c0b8,%eax
 ...
 8049a4d:	0f b6 05 b8 c0 04 08 	movzbl 0x804c0b8,%eax
 ...
 8049a68:	0f b6 05 b8 c0 04 08 	movzbl 0x804c0b8,%eax
...
08049afa <main>:
 ...
 8049b0e:	a1 80 c0 04 08       	mov    0x804c080,%eax
 8049b13:	a3 a8 c0 04 08       	mov    %eax,0x804c0a8
 ...
 8049b93:	a1 ac c0 04 08       	mov    0x804c0ac,%eax
 8049b98:	85 c0                	test   %eax,%eax
 8049b9a:	74 37                	je     8049bd3 <main+0xd9>
 8049b9c:	a1 b0 c0 04 08       	mov    0x804c0b0,%eax
 ...
 8049bd3:	a1 78 c0 04 08       	mov    0x804c078,%eax
 8049bd8:	85 c0                	test   %eax,%eax
 8049bda:	74 09                	je     8049be5 <main+0xeb>
 8049bdc:	a1 78 c0 04 08       	mov    0x804c078,%eax
...
08049c04 <BLHwXcxe>:
 ...
 8049c10:	e8 eb f4 ff ff       	call   8049100 <puts@plt>
 8049c15:	83 c4 10             	add    $0x10,%esp
 8049c18:	a1 ac c0 04 08       	mov    0x804c0ac,%eax
 8049c1d:	83 f8 01             	cmp    $0x1,%eax
 8049c20:	75 10                	jne    8049c32 <BLHwXcxe+0x2e>
 8049c22:	83 ec 08             	sub    $0x8,%esp
 8049c25:	ff 75 08             	push   0x8(%ebp)
 8049c28:	6a 02                	push   $0x2
 8049c2a:	e8 d0 f8 ff ff       	call   80494ff <client>
 8049c2f:	83 c4 10             	add    $0x10,%esp
 8049c32:	83 ec 0c             	sub    $0xc,%esp
 8049c35:	6a 01                	push   $0x1
 8049c37:	e8 e4 f4 ff ff       	call   8049120 <exit@plt>

08049c3c <do_phase>:
 8049c3c:	55                   	push   %ebp
 8049c3d:	89 e5                	mov    %esp,%ebp
 8049c3f:	90                   	nop
 8049c40:	90                   	nop
 8049c41:	90                   	nop
 8049c42:	90                   	nop
...
08049c64 <_fini>:
 8049c64:	f3 0f 1e fb          	endbr32 
 8049c68:	53                   	push   %ebx
 8049c69:	83 ec 08             	sub    $0x8,%esp
 8049c6c:	e8 af f5 ff ff       	call   8049220 <__x86.get_pc_thunk.bx>
 8049c71:	81 c3 8f 23 00 00    	add    $0x238f,%ebx
 8049c77:	83 c4 08             	add    $0x8,%esp
 8049c7a:	5b                   	pop    %ebx
 8049c7b:	c3                   	ret    
