...
08049230 <deregister_tm_clones>:
 8049230:	b8 88 c0 04 08       	mov    $0x804c088,%eax
 8049235:	3d 88 c0 04 08       	cmp    $0x804c088,%eax
 ...
 804924b:	68 88 c0 04 08       	push   $0x804c088
...
08049270 <register_tm_clones>:
 8049270:	b8 88 c0 04 08       	mov    $0x804c088,%eax
 8049275:	2d 88 c0 04 08       	sub    $0x804c088,%eax
 ...
 8049297:	50                   	push   %eax
 8049298:	68 88 c0 04 08       	push   $0x804c088
...
080492b0 <__do_global_dtors_aux>:
 ...
 80492b4:	80 3d c4 c0 04 08 00 	cmpb   $0x0,0x804c0c4
 ...
 80492c8:	c6 05 c4 c0 04 08 01 	movb   $0x1,0x804c0c4
 80492cf:	c9                   	leave  
 80492d0:	c3                   	ret    
...
0804932b <sendfile>:
 ...
 8049416:	a1 d4 c0 04 08       	mov    0x804c0d4,%eax
...
080494ff <client>:
 ...
 8049580:	a3 d4 c0 04 08       	mov    %eax,0x804c0d4
 ...
 804966a:	a1 d0 c0 04 08       	mov    0x804c0d0,%eax
 ...
 8049737:	68 d9 c0 04 08       	push   $0x804c0d9
 804973c:	ff b5 6c ff ff ff    	push   -0x94(%ebp)
 8049742:	e8 59 fa ff ff       	call   80491a0 <recv@plt>
 8049747:	83 c4 10             	add    $0x10,%esp
 804974a:	0f b6 05 d9 c0 04 08 	movzbl 0x804c0d9,%eax
 8049751:	83 e8 30             	sub    $0x30,%eax
 8049754:	a2 d9 c0 04 08       	mov    %al,0x804c0d9
 8049759:	0f b6 05 d9 c0 04 08 	movzbl 0x804c0d9,%eax
 ...
 80499e6:	0f b6 05 d8 c0 04 08 	movzbl 0x804c0d8,%eax
 ...
 8049a06:	0f b6 05 d8 c0 04 08 	movzbl 0x804c0d8,%eax
 ...
 8049a4d:	0f b6 05 d8 c0 04 08 	movzbl 0x804c0d8,%eax
 ...
 8049a68:	0f b6 05 d8 c0 04 08 	movzbl 0x804c0d8,%eax
...
08049afa <main>:
 ...
 8049b0e:	a1 a0 c0 04 08       	mov    0x804c0a0,%eax
 8049b13:	a3 c8 c0 04 08       	mov    %eax,0x804c0c8
 ...
 8049b93:	a1 cc c0 04 08       	mov    0x804c0cc,%eax
 8049b98:	85 c0                	test   %eax,%eax
 8049b9a:	74 37                	je     8049bd3 <main+0xd9>
 8049b9c:	a1 d0 c0 04 08       	mov    0x804c0d0,%eax
 ...
 8049bd3:	a1 84 c0 04 08       	mov    0x804c084,%eax
 8049bd8:	85 c0                	test   %eax,%eax
 8049bda:	74 09                	je     8049be5 <main+0xeb>
 8049bdc:	a1 84 c0 04 08       	mov    0x804c084,%eax
...
08049c04 <transform_code>:
 8049c04:	55                   	push   %ebp
 8049c05:	89 e5                	mov    %esp,%ebp
 8049c07:	8b 45 0c             	mov    0xc(%ebp),%eax //0x0 ~ 0xc 计数器
 8049c0a:	8b 04 85 e0 a3 04 08 	mov    0x804a3e0(,%eax,4),%eax //*
 8049c11:	83 e0 07             	and    $0x7,%eax
 8049c14:	83 f8 07             	cmp    $0x7,%eax
 8049c17:	77 63                	ja     8049c7c <transform_code+0x78>
 8049c19:	8b 04 85 a0 a4 04 08 	mov    0x804a4a0(,%eax,4),%eax
 8049c20:	ff e0                	jmp    *%eax
 8049c22:	f7 55 08             	notl   0x8(%ebp) //0    !CODE
 8049c25:	eb 59                	jmp    8049c80 <transform_code+0x7c>
 8049c27:	8b 45 0c             	mov    0xc(%ebp),%eax //1  
 8049c2a:	8b 04 85 e0 a3 04 08 	mov    0x804a3e0(,%eax,4),%eax
 8049c31:	83 e0 03             	and    $0x3,%eax
 8049c34:	89 c1                	mov    %eax,%ecx
 8049c36:	d3 7d 08             	sarl   %cl,0x8(%ebp)
 8049c39:	eb 45                	jmp    8049c80 <transform_code+0x7c>
 8049c3b:	8b 45 0c             	mov    0xc(%ebp),%eax //3
 8049c3e:	8b 04 85 e0 a3 04 08 	mov    0x804a3e0(,%eax,4),%eax
 8049c45:	f7 d0                	not    %eax
 8049c47:	21 45 08             	and    %eax,0x8(%ebp)
 8049c4a:	eb 34                	jmp    8049c80 <transform_code+0x7c>
 8049c4c:	8b 45 0c             	mov    0xc(%ebp),%eax  // 4
 8049c4f:	8b 04 85 e0 a3 04 08 	mov    0x804a3e0(,%eax,4),%eax
 8049c56:	c1 e0 08             	shl    $0x8,%eax
 8049c59:	09 45 08             	or     %eax,0x8(%ebp)
 8049c5c:	eb 22                	jmp    8049c80 <transform_code+0x7c>
 8049c5e:	8b 45 0c             	mov    0xc(%ebp),%eax  // 5
 8049c61:	8b 04 85 e0 a3 04 08 	mov    0x804a3e0(,%eax,4),%eax
 8049c68:	31 45 08             	xor    %eax,0x8(%ebp)
 8049c6b:	eb 13                	jmp    8049c80 <transform_code+0x7c>
 8049c6d:	8b 45 0c             	mov    0xc(%ebp),%eax //7
 8049c70:	8b 04 85 e0 a3 04 08 	mov    0x804a3e0(,%eax,4),%eax
 8049c77:	89 45 08             	mov    %eax,0x8(%ebp)
 8049c7a:	eb 04                	jmp    8049c80 <transform_code+0x7c>
 8049c7c:	f7 5d 08             	negl   0x8(%ebp) //2 6
 8049c7f:	90                   	nop
 8049c80:	8b 45 08             	mov    0x8(%ebp),%eax
 8049c83:	5d                   	pop    %ebp
 8049c84:	c3                   	ret    

08049c85 <generate_code>:
 8049c85:	55                   	push   %ebp
 8049c86:	89 e5                	mov    %esp,%ebp
 8049c88:	83 ec 10             	sub    $0x10,%esp
 8049c8b:	8b 45 08             	mov    0x8(%ebp),%eax
 8049c8e:	a2 83 c0 04 08       	mov    %al,0x804c083 //CODE
 8049c93:	c7 45 fc 00 00 00 00 	movl   $0x0,-0x4(%ebp)
 8049c9a:	eb 1f                	jmp    8049cbb <generate_code+0x36>
 8049c9c:	0f b6 05 83 c0 04 08 	movzbl 0x804c083,%eax //CODE
 8049ca3:	0f be c0             	movsbl %al,%eax //符号扩展
 8049ca6:	ff 75 fc             	push   -0x4(%ebp)
 8049ca9:	50                   	push   %eax
 8049caa:	e8 55 ff ff ff       	call   8049c04 <transform_code>
 8049caf:	83 c4 08             	add    $0x8,%esp
 8049cb2:	a2 83 c0 04 08       	mov    %al,0x804c083  //CODE
 8049cb7:	83 45 fc 01          	addl   $0x1,-0x4(%ebp)
 8049cbb:	8b 45 fc             	mov    -0x4(%ebp),%eax
 8049cbe:	83 f8 0c             	cmp    $0xc,%eax
 8049cc1:	76 d9                	jbe    8049c9c <generate_code+0x17>
 8049cc3:	90                   	nop
 8049cc4:	c9                   	leave  
 8049cc5:	c3                   	ret    
...
08049cc6 <encode>:
 8049cc6:	55                   	push   %ebp
 8049cc7:	89 e5                	mov    %esp,%ebp
 8049cc9:	83 ec 18             	sub    $0x18,%esp
 8049ccc:	83 ec 0c             	sub    $0xc,%esp
 8049ccf:	ff 75 08             	push   0x8(%ebp)
 8049cd2:	e8 59 f4 ff ff       	call   8049130 <strlen@plt>
 8049cd7:	83 c4 10             	add    $0x10,%esp
 8049cda:	89 45 f4             	mov    %eax,-0xc(%ebp) //长度
 8049cdd:	c7 45 f0 00 00 00 00 	movl   $0x0,-0x10(%ebp) //i
 8049ce4:	eb 58                	jmp    8049d3e <encode+0x78>
 8049ce6:	8b 55 f0             	mov    -0x10(%ebp),%edx
 8049ce9:	8b 45 08             	mov    0x8(%ebp),%eax
 8049cec:	01 c2                	add    %eax,%edx
 8049cee:	8b 4d f0             	mov    -0x10(%ebp),%ecx
 8049cf1:	8b 45 08             	mov    0x8(%ebp),%eax
 8049cf4:	01 c8                	add    %ecx,%eax
 8049cf6:	0f b6 00             	movzbl (%eax),%eax
 8049cf9:	0f be c0             	movsbl %al,%eax
 8049cfc:	0f b6 88 20 a4 04 08 	movzbl 0x804a420(%eax),%ecx //*
 8049d03:	0f b6 05 83 c0 04 08 	movzbl 0x804c083,%eax
 8049d0a:	31 c8                	xor    %ecx,%eax
 8049d0c:	83 e0 7f             	and    $0x7f,%eax
 8049d0f:	88 02                	mov    %al,(%edx)
 8049d11:	8b 55 f0             	mov    -0x10(%ebp),%edx
 8049d14:	8b 45 08             	mov    0x8(%ebp),%eax
 8049d17:	01 d0                	add    %edx,%eax
 8049d19:	0f b6 00             	movzbl (%eax),%eax
 8049d1c:	3c 1f                	cmp    $0x1f,%al
 8049d1e:	7e 0f                	jle    8049d2f <encode+0x69>
 8049d20:	8b 55 f0             	mov    -0x10(%ebp),%edx
 8049d23:	8b 45 08             	mov    0x8(%ebp),%eax
 8049d26:	01 d0                	add    %edx,%eax
 8049d28:	0f b6 00             	movzbl (%eax),%eax
 8049d2b:	3c 7f                	cmp    $0x7f,%al
 8049d2d:	75 0b                	jne    8049d3a <encode+0x74>
 8049d2f:	8b 55 f0             	mov    -0x10(%ebp),%edx
 8049d32:	8b 45 08             	mov    0x8(%ebp),%eax
 8049d35:	01 d0                	add    %edx,%eax
 8049d37:	c6 00 20             	movb   $0x20,(%eax)
 8049d3a:	83 45 f0 01          	addl   $0x1,-0x10(%ebp)
 8049d3e:	8b 45 f0             	mov    -0x10(%ebp),%eax
 8049d41:	3b 45 f4             	cmp    -0xc(%ebp),%eax
 8049d44:	7c a0                	jl     8049ce6 <encode+0x20>
 8049d46:	8b 45 f4             	mov    -0xc(%ebp),%eax
 8049d49:	c9                   	leave  
 8049d4a:	c3                   	ret    
...
08049d4b <do_phase>:
 ...
 8049d4e:	83 ec 08             	sub    $0x8,%esp
 8049d51:	68 82 00 00 00       	push   $0x82
 8049d56:	e8 2a ff ff ff       	call   8049c85 <generate_code>
 8049d5b:	83 c4 04             	add    $0x4,%esp
 8049d5e:	83 ec 0c             	sub    $0xc,%esp
 8049d61:	68 78 c0 04 08       	push   $0x804c078
 8049d66:	e8 5b ff ff ff       	call   8049cc6 <encode> //*
 8049d6b:	83 c4 10             	add    $0x10,%esp
 8049d6e:	83 ec 0c             	sub    $0xc,%esp
 8049d71:	68 78 c0 04 08       	push   $0x804c078
 8049d76:	e8 85 f3 ff ff       	call   8049100 <puts@plt>
 8049d7b:	83 c4 10             	add    $0x10,%esp
 8049d7e:	a1 cc c0 04 08       	mov    0x804c0cc,%eax
 8049d83:	83 f8 01             	cmp    $0x1,%eax
 8049d86:	75 12                	jne    8049d9a <do_phase+0x4f>
 8049d88:	83 ec 08             	sub    $0x8,%esp
 8049d8b:	68 78 c0 04 08       	push   $0x804c078
 8049d90:	6a 05                	push   $0x5
 8049d92:	e8 68 f7 ff ff       	call   80494ff <client>
 8049d97:	83 c4 10             	add    $0x10,%esp
 8049d9a:	90                   	nop
 8049d9b:	c9                   	leave  
 8049d9c:	c3                   	ret    
...
08049da0 <_fini>:
 8049da0:	f3 0f 1e fb          	endbr32 
 8049da4:	53                   	push   %ebx
 8049da5:	83 ec 08             	sub    $0x8,%esp
 8049da8:	e8 73 f4 ff ff       	call   8049220 <__x86.get_pc_thunk.bx>
 8049dad:	81 c3 53 22 00 00    	add    $0x2253,%ebx
