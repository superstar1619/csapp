...
08049c04 <transform_code>:
 ...
 8049c07:	8b 45 0c             	mov    0xc(%ebp),%eax //0x0 ~ 0xc
 ...
 8049c22:	f7 55 08             	notl   0x8(%ebp) //0
...
08049c85 <generate_code>:
 ...
 8049ca3:	0f be c0             	movsbl %al,%eax
...
08049cc6 <encode>:
 ...
 8049cda:	89 45 f4             	mov    %eax,-0xc(%ebp)
 8049cdd:	c7 45 f0 00 00 00 00 	movl   $0x0,-0x10(%ebp)
 ...
 8049cfc:	0f b6 88 83 c0 04 08 	movzbl 0x804c083(%eax),%ecx //*
